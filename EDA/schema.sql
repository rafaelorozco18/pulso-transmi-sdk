...
--
-- Este archivo es la foto completa del esquema. Lo desplegado en Supabase se
-- versiona como migraciones en supabase/migrations/ (aplicar con `supabase db push`).
--
...
-- -----------------------------------------------------------------------------
-- Índices de llaves foráneas (Performance Advisor de Supabase)
-- -----------------------------------------------------------------------------
